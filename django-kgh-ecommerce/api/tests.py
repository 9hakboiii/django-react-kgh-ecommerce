...
class ApiTest(TestCase):
    def test_jwt_decode_access_token(self):
        access_token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNzQ2MDY0MDM4LCJpYXQiOjE3NDYwNjM4NTgsImp0aSI6IjkwNTViMzkyYmFkYTRlMjY4OGEyZjg4ZWM5N2VlMDg5IiwidXNlcl9pZCI6MX0.lk70FYQCWlVoewhWrNWckVVfpbk7j0b822_u8_MNKN4"
        refresh_token =  "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoicmVmcmVzaCIsImV4cCI6MTc0NjY2ODY1OCwiaWF0IjoxNzQ2MDYzODU4LCJqdGkiOiIzNzljZGM5ODkxZmM0N2VjOTA3YWM2MmEyNmFlY2YzOSIsInVzZXJfaWQiOjF9.iYWWlKbeKhAzIujCnOw9GE3ThO-KqRtF7TFs4bSucMM"
